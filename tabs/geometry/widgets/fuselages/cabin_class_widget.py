...
class CabinClassWidget(QWidget):
    ...
    def init_ui(self, section_data):
        ...
        # add spacing, buttons and drop down to header layout
        ...
        #list of types of "classes" for cabins
        ...
        #adding data entry widget (labels) to main layout
    ...
    def create_rcaide_structure(self, data):
        #creating the correct class type based on user selection
    ...
    def delete_clicked(self):
        #calling on_delete callback when delete button is pressed
        if self.on_delete:
