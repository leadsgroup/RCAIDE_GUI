...
from utilities import show_popup, create_line_bar, Units, set_data, clear_layout,create_scroll_area
...
class WingsFrame(GeometryFrame):
    def __init__(self):
        ...
        wing_content_widget = QWidget()
        self.content_layout = QVBoxLayout(wing_content_widget)
        ...
        self.content_layout.addLayout(self.wing_sections_layout)

        self.wing_cs_layout = QVBoxLayout()
        self.content_layout.addWidget(create_line_bar())
        self.content_layout.addLayout(self.wing_cs_layout)
        ...
        collapsible = CollapsibleSection("Wing", wing_content_widget)
...
class WingsFrame(GeometryFrame):
    def __init__(self):
        ...
        wing_content_widget = QWidget()
        wing_content_layout = QVBoxLayout(wing_content_widget)

        wing_content_layout.addWidget(create_line_bar())
        self.add_name_layout(wing_content_layout)
        ...
        self.data_entry_widget = DataEntryWidget(self.data_units_labels)
        wing_content_layout.addWidget(self.data_entry_widget)
        wing_content_layout.addWidget(create_line_bar())

        self.wing_sections_layout = QVBoxLayout()
        wing_content_layout.addLayout(self.wing_sections_layout)

        self.wing_cs_layout = QVBoxLayout()
        wing_content_layout.addWidget(create_line_bar())
        wing_content_layout.addLayout(self.wing_cs_layout)

        #self.add_buttons_layout(wing_content_layout)
        self.add_buttons_layout

        wing_content_layout.addItem(QSpacerItem(
            20, 40, QSizePolicy.Policy.MinimumExpanding, QSizePolicy.Policy.Expanding
        ))

        collapsible = CollapsibleSection("Wing", wing_content_widget, scrollable=False)
        main_layout.addWidget(collapsible)
