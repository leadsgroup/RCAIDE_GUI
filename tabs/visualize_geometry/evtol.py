...
def EVTOL_vehicle_setup() :
    ...
    evtol_path = os.path.join(airfoil_dir, 'NACA_4412.txt')
    naca_63_412_path = os.path.join(airfoil_dir, 'NACA_63_412.txt')
    ospath                        = os.path.abspath(__file__) 
    separator                     = os.path.sep
    rel_path                      = os.path.dirname(ospath) + separator  + '..'  + separator 
    airfoil                       = RCAIDE.Library.Components.Airfoils.Airfoil()
    airfoil.coordinate_file       = naca_63_412_path
    ...
    airfoil.coordinate_file                                = evtol_path
    airfoil.polar_files                                    = [os.path.join(polar_dir, 'NACA_4412_polar_Re_50000.txt') ,
                                                             os.path.join(polar_dir, 'NACA_4412_polar_Re_100000.txt'),
                                                              ...
                                                              os.path.join(polar_dir, 'NACA_4412_polar_Re_3500000.txt'),
                                                              os.path.join(polar_dir, 'NACA_4412_polar_Re_5000000.txt'),
                                                              os.path.join(polar_dir, 'NACA_4412_polar_Re_7500000.txt') ]
